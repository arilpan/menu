...
import com.xdkj.campus.menu.api.message.APPShopEnviroment;
...
//    }
    ...
    public void gotoSubscribe()
    {
        EventBus.getDefault().post(
                new StartBrotherEvent(SelectPlaceFragment.newInstance(shop_id)));
    }
...
// moshi.adapter(type);
            ...
            final JsonAdapter<APPShopEnviroment>
                    COM_JSON_ADAPTER = MainActivity.MOSHI.adapter(
                    Types.newParameterizedType(APPShopEnviroment.class));
