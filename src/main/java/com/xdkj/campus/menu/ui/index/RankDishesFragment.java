...
//                        new StartBrotherEvent(DishDetailFragment.newInstance(1)));
    ...
    private boolean isShopOne() {
        return shop_id.equals(APIAddr.shop_one_id);
    }
    ...
    public List<APPRank.ValueBean.DataBean> getData(String url) {
        ...
        try {
            ...
            Log.e("arilpan", ",code :" + newdatas.size());
            return newdatas;
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
    ...
    public static List<APPRank.ValueBean.DataBean> removeDuplicate(List<APPRank.ValueBean.DataBean> list) {
        ...
        try {
            ...
            _mActivity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (shop_id.equals(APIAddr.shop_one_id)) {
                        datas.addAll(items);
                        removeDuplicate(datas);
                        mAdapter.setDatas(datas);
                    } else if (shop_id.equals(APIAddr.shop_two_id)) {
