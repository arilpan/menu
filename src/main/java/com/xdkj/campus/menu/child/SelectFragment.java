...
public class SelectFragment extends BaseFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        int[] resIds = {R.drawable.ic_account_circle_white_48dp, R.drawable.ic_account_circle_white_48dp,
                R.drawable.ic_account_circle_white_48dp, R.drawable.ic_account_circle_white_48dp};
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(getContext(), item, R.layout.fragment_select_dishes_grid_item, new String[]
                {"item_image", "item_left", "item_middle", "item_right"},
                new int[]{R.id.item_image, R.id.item_left, R.id.item_middle, R.id.item_right}) {
        };
