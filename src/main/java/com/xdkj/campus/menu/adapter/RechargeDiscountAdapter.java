 ...
 */
public class RechargeDiscountAdapter extends RecyclerView.Adapter<RechargeDiscountAdapter
        .MyViewHolder>
{
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        View view = mInflater.inflate(R.layout.fragment_discount_list_item
                , parent, false);
...
//                    {
//                        holder.item_bg.setBackground(new BitmapDrawable(bitmap));
//                    }
//
//                    @Override
