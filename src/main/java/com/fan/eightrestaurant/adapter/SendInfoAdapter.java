    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            switch (getItemViewType(position)){
                case LEFT:
                    convertView = LayoutInflater.from(context).inflate(R.layout.fragment_listview_item_left,null);
                    viewHolder.showTime = (TextView) convertView.findViewById(R.id.eight_list_item_fromtime);
                    viewHolder.showContent = (TextView) convertView.findViewById(R.id.eight_list_item_fromtext);
                    break;
                case RIGHT:
