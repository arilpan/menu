...
public class EightFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,  Bundle savedInstanceState) {
        View ret = null;
        ret = inflater.inflate(R.layout.fragment_eight,null);
        listView = (ListView) ret.findViewById(R.id.fragment_eight_listview);
        sendInfo = (Button) ret.findViewById(R.id.fragment_eight_sendbtn);
     ...
     * @param scrollToView   被键盘遮挡住的scrollToView，滚动root，使scrollToView在root可视区域的底部
     */
