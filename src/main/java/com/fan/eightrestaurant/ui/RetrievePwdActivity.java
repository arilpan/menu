    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.retrieve_button:
                if(userPwd.getText().toString().trim().length()<6||userPwd.getText().toString().trim().length()>16){
                                ...
                                public void onResponse(String response) {
                                    try {
                                        ...
                                        if(message.equals("serversError")){
                                            Toast.makeText(RetrievePwdActivity.this,"服务器出问题了",Toast.LENGTH_SHORT).show();
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        if(message.equals("sendError")){
                                            ...
                                            Toast.makeText(RetrievePwdActivity.this,"手机号码已被注册",Toast.LENGTH_SHORT).show();
                                        }else if(message.equals("error")){
                                            Toast.makeText(RetrievePwdActivity.this,"手机号码格式错误",Toast.LENGTH_SHORT).show();
                                        }else if(message.equals("ok")){
